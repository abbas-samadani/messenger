                            ...
                            <ul className="files">
                                <li>
                                    <ul className="avatars">
                                        <li><button className="btn round"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-file-text"><g data-name="Layer 2"><g data-name="file-text"><rect width={24} height={24} opacity={0} /><path d="M19.74 7.33l-4.44-5a1 1 0 0 0-.74-.33h-8A2.53 2.53 0 0 0 4 4.5v15A2.53 2.53 0 0 0 6.56 22h10.88A2.53 2.53 0 0 0 20 19.5V8a1 1 0 0 0-.26-.67zM9 12h3a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2zm6 6H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-.29-10a.79.79 0 0 1-.71-.85V4l3.74 4z" /></g></g></svg></button></li>
                                        <li><a href="#/"><img src="assets/img/avatars/avatar-male-1.jpg" alt="avatar" /></a></li>
                                    </ul>
                                    <div className="meta">
                                ...
                                <li>
                                    <ul className="avatars">
                                        <li><button className="btn round"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-folder"><g data-name="Layer 2"><g data-name="folder"><rect width={24} height={24} opacity={0} /><path d="M19.5 20.5h-15A2.47 2.47 0 0 1 2 18.07V5.93A2.47 2.47 0 0 1 4.5 3.5h4.6a1 1 0 0 1 .77.37l2.6 3.18h7A2.47 2.47 0 0 1 22 9.48v8.59a2.47 2.47 0 0 1-2.5 2.43z" /></g></g></svg></button></li>
                                        <li><a href="#/"><img src="assets/img/avatars/avatar-male-2.jpg" alt="avatar" /></a></li>
                                    </ul>
                                    <div className="meta">
                                ...
                                <li>
                                    <ul className="avatars">
                                        <li><button className="btn round"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-folder"><g data-name="Layer 2"><g data-name="folder"><rect width={24} height={24} opacity={0} /><path d="M19.5 20.5h-15A2.47 2.47 0 0 1 2 18.07V5.93A2.47 2.47 0 0 1 4.5 3.5h4.6a1 1 0 0 1 .77.37l2.6 3.18h7A2.47 2.47 0 0 1 22 9.48v8.59a2.47 2.47 0 0 1-2.5 2.43z" /></g></g></svg></button></li>
                                        <li><a href="#/"><img src="assets/img/avatars/avatar-male-5.jpg" alt="avatar" /></a></li>
                                    </ul>
                                    <div className="meta">
                                ...
                                <li>
                                    <ul className="avatars">
                                        <li><button className="btn round"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-file-text"><g data-name="Layer 2"><g data-name="file-text"><rect width={24} height={24} opacity={0} /><path d="M19.74 7.33l-4.44-5a1 1 0 0 0-.74-.33h-8A2.53 2.53 0 0 0 4 4.5v15A2.53 2.53 0 0 0 6.56 22h10.88A2.53 2.53 0 0 0 20 19.5V8a1 1 0 0 0-.26-.67zM9 12h3a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2zm6 6H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-.29-10a.79.79 0 0 1-.71-.85V4l3.74 4z" /></g></g></svg></button></li>
                                        <li><a href="#/"><img src="assets/img/avatars/avatar-male-6.jpg" alt="avatar" /></a></li>
                                    </ul>
                                    <div className="meta">
