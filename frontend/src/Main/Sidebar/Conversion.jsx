    ...
    render() {
        return (
            ...
            <div className="middle">
              <h4>Discussions</h4>
              <button type="button" className="btn round" data-toggle="modal" data-target="#compose"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-edit-2"><g data-name="Layer 2"><g data-name="edit-2"><rect width={24} height={24} opacity={0} /><path d="M19 20H5a1 1 0 0 0 0 2h14a1 1 0 0 0 0-2z" /><path d="M5 18h.09l4.17-.38a2 2 0 0 0 1.21-.57l9-9a1.92 1.92 0 0 0-.07-2.71L16.66 2.6A2 2 0 0 0 14 2.53l-9 9a2 2 0 0 0-.57 1.21L4 16.91a1 1 0 0 0 .29.8A1 1 0 0 0 5 18zM15.27 4L18 6.73l-2 1.95L13.32 6z" /></g></g></svg></button>
              <hr />
              <ul className="nav discussions" role="tablist">
                ...
                <li>
                  <a href="#chat2" className="filter groups" data-chat="open" data-toggle="tab" role="tab" aria-controls="chat2" aria-selected="false" style={{display: 'none'}}>
                    <div className="content">
                      <div className="headline">
                        <img src="assets/img/avatars/avatar-group-1.jpg" alt="avatar" />
                ...
                <li>
                  <a href="#chat2" className="filter groups" data-chat="open" data-toggle="tab" role="tab" aria-controls="chat2" aria-selected="false" style={{display: 'none'}}>
                    <div className="content">
                      <div className="headline">
                        <img src="assets/img/avatars/avatar-group-2.jpg" alt="avatar" />
                        <h5>Watts Up</h5>
                        <span>Today</span>
                      </div>
                      <p>Additional information about the previous clients.</p>
                ...
                <li>
                  <a href="#chat2" className="filter groups" data-chat="open" data-toggle="tab" role="tab" aria-controls="chat2" aria-selected="false" style={{display: 'none'}}>
                    <div className="content">
                      <div className="headline">
                        <img src="assets/img/avatars/avatar-group-3.jpg" alt="avatar" />
                        <h5>Memes</h5>
                        <span>Feb 23</span>
                      </div>
                      <p>I'm looking to get a quote for the move from LA to NY.</p>
                ...
                <li>
                  <a href="#chat2" className="filter groups" data-chat="open" data-toggle="tab" role="tab" aria-controls="chat2" aria-selected="false" style={{display: 'none'}}>
                    <div className="content">
                      <div className="headline">
                        <img src="assets/img/avatars/avatar-group-4.jpg" alt="avatar" />
                        <h5>Supernovas</h5>
                        <span>Jan 18</span>
                      </div>
                      <p>My delivery address is pending final confirmation.</p>
                ...
                <li>
                  <a href="#chat2" className="filter groups" data-chat="open" data-toggle="tab" role="tab" aria-controls="chat2" aria-selected="false" style={{display: 'none'}}>
                    <div className="content">
                      <div className="headline">
                        <img src="assets/img/avatars/avatar-group-5.jpg" alt="avatar" />
                        <h5>Squad Ghouls</h5>
                        <span>May 2</span>
                      </div>
                      <p>Sending all the requested insurance documents.</p>
